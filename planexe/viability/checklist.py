...
CHECKLIST = [
    ...
    },
    {
        ...
        "instruction": "Act as a technical due diligence expert. Your goal is to distinguish between a plan with a sound engineering foundation and one that is superficial. Follow these steps:\n1.  **Identify Core Technical Challenges:** Pinpoint the 1-3 most difficult engineering, construction, or software components in the plan.\n2.  **Scrutinize the 'How':** For these challenges, does the plan detail *how* they will be overcome, or does it simply state *what* will be achieved?\n3.  **Look for Evidence:** Check for references to specific technical artifacts, such as blueprints, system architecture diagrams, bills of materials (BOM), data flow models, or detailed logistics plans.\n4.  **Flag 'Magic Box' Language:** Identify any section that treats a complex component as a solved 'magic box' (e.g., 'the AI will optimize logistics') without explaining the inputs, outputs, and internal process.",
