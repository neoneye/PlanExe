...
class TestExportGanttCSV(unittest.TestCase):
    ...
    def test_to_gantt_csv(self):
        ...
        # Assert
        self.assertIn("project_key;project_name;originating_department;project_description;project_start_date;project_end_date;project_progress;parent_project_key", s)
        self.assertIn("A;TitleA;PlanExe;A tooltip;8/4/2025;8/7/2025;0;", s)
        self.assertIn("C;TitleC;PlanExe;C_C_C;8/4/2025;8/6/2025;0;A", s)
