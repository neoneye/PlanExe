...
"""
PROMPT> python -m worker_plan_internal.diagnostics.experimental_premise_attack3 --brief-file /absolute/path/to/plan.txt
"""
...
if __name__ == "__main__":
    ...
    try:
        ...
        raise SystemExit(f"Missing worker_plan_internal.llm_factory.get_llm in your environment: {e}")
