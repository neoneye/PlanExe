...
Every typescript file you create or edit should start with:
```
/**
...
- **Port Documentation**: Some docs incorrectly mention port 8001 (actual backend port is 8080)
...
- [ ] LLM models load correctly (http://localhost:8080/api/models)
...
2. **Verify services**: http://localhost:3000 (frontend) + http://localhost:8080/health (backend)
