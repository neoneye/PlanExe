"""
PROMPT> HUGGINGFACE_SPACES_BROWSERSTATE_SECRET=hello python -m planexe.huggingface_spaces.huggingface_spaces_browserstate_secret
hello

PROMPT> python -m planexe.huggingface_spaces.huggingface_spaces_browserstate_secret
None
"""
import os
