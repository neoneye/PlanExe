...
class FilenameEnum(str, Enum):
    ...
    IDENTIFY_RISKS_RAW = "002-7-identify_risks_raw.json"
    IDENTIFY_RISKS_MARKDOWN = "002-8-identify_risks.md"
    MAKE_ASSUMPTIONS_RAW = "002-9-make_assumptions_raw.json"
    MAKE_ASSUMPTIONS_CLEAN = "002-10-make_assumptions.json"
    MAKE_ASSUMPTIONS_MARKDOWN = "002-11-make_assumptions.md"
