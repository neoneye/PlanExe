...
class FilenameEnum(str, Enum):
    ...
    GOVERNANCE_PHASE5_MONITORING_PROGRESS_RAW = "005-11-governance_phase5_monitoring_progress_raw.json"
    GOVERNANCE_PHASE5_MONITORING_PROGRESS_MARKDOWN = "005-12-governance_phase5_monitoring_progress.md"
    GOVERNANCE_RAW = "005-13-governance_raw.json"
    GOVERNANCE_MARKDOWN = "005-14-governance.md"
