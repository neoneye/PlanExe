...
echo "5. Deploy API service using docker/Dockerfile.railway.api"
echo "6. Deploy frontend service using docker/Dockerfile.railway.ui"
echo "7. Set environment variables from .env.railway.example"
echo "
